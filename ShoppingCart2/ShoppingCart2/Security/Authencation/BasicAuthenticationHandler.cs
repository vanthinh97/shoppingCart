...
namespace ShoppingCart2.Security.Authencation
{
    public class BasicAuthenticationHandler : AuthenticationHandler<BasicAuthenticationOptions>
    {
        ...
        public BasicAuthenticationHandler(IOptionsMonitor<BasicAuthenticationOptions> options,
            ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, ShoppingCartContext context)
        ...
        {
            Response.Headers["WWW-Authenticate"] = $"Basic realm=\"http://localhost:44354\", charset=\"UTF-8\"";
